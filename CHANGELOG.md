...
Fixed example in `mise-task.instructions.md` to correctly show how usage is invoked.
...
- Created test fixtures for various changelog scenarios
- Implemented 13 tests covering all version specification methods

## 0.1.15 (2026-01-04)

- Introduced Zig API design for mise task migration
- Added specification document for 11 shell script behaviors

## 0.1.14 (2026-01-03)

- Added metadata fields to all mise tasks for improved discoverability
- Enabled incremental builds with sources/outputs metadata (30x speedup for cached tasks)
- Added comprehensive mise task guidelines to CONTRIBUTING.md
